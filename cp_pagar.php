<?php $titulo = "Pagar Cheque Propio"; ?>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE [".get_db()."].[dbo].[tb_cheque_p] SET cp_observacion = '".$cp_observacion."', cp_estado = 'PAGADO' WHERE id = '".$id."'";
